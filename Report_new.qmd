...
```{r, warning=FALSE, message=FALSE}
rt <- read.csv('All_Running_time.csv')
...
![Cluster1](figure1.png)
![Cluster2](figure2.png)
![Cluster3](figure3.png)
![Cluster4](figure4.png)
![Cluster5](figure5.png)
![Cluster6](figure6.png)
